        ...
        <hr>
        	<div class="btn-area" align="right">
                ...
                <% if(r.getReviewStatus().equals("등록")) {%>
                	<a class="btn btn-sm" id="del-btn" style="background:rgb(22, 160, 133); color:white;" href="<%=contextPath %>/deleteReview.tt?reNo=<%=r.getReviewNo()%>">삭제</a>
            	<% } %>
            </div>
            <br>

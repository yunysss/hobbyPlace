		...
		<div id="menubar">
	        ...
	        <div id="menubar-2">
	            ...
	            <div id="membership" align="center">
					...
					<%}else{ %>
		                <!-- 로그인 후 -->
		                <a href="<%=contextPath%>/myClassList.reg?cpage=1">마이클래스</a>
						...
						<div class="dropdown-menu">
						    ...
						    <a class="dropdown-item" href="<%=contextPath%>/likeList.tee">내가 찜한 목록</a>

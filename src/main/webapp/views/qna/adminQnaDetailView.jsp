...
<%@ include file="../common/adminMenubar.jsp"%>
    <div class="outer">
        ...
        <hr>
            ...
            <div style="border: 1px solid lightgray; padding: 10px; width: 1000px; height: 300px; margin-left:auto;margin-right:auto;">
                <p><%=q.getqContent() %></p>
	            ...
	            <input type="hidden" name="no" value"<%=q.getqNo() %>">
	                <table>
	                    <tr>
	                        ...
	                        <td >
	                            <input type="text" name="atitle" style="width: 900px; height: 50px;resize: none; border-color: lightgray;" required placeholder="제목을 입력하세요.">
	                        </td>
	                    </tr>
	                ...
	                <table>
	                    <tr>
	                        <td><textarea name="acontent" rows="10" required style="resize:none; width:1000px; height: 500px; border-color: lightgray;"  ></textarea></td>
	                    </tr>

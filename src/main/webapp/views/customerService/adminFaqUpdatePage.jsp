        ...
        <form action="<%=contextPath %>/faqUpdate.ad" method="post">
            ...
            <table>
                <tr>
                    ...
                    <td >
                        <input type="text" name="title" value ="<%=f.getQuestion()%>"style="width: 900px; height: 50px;resize: none; border-color: lightgray; border: none;" required placeholder="제목을 입력하세요.">
                    </td>
                </tr>
            ...
            <table>
                <tr>
                    <td><textarea name="content" rows="10" required style="resize:none; width:1000px; height: 500px; border-color: lightgray; border: none;"  ><%=f.getAnswer() %></textarea></td>
                </tr>

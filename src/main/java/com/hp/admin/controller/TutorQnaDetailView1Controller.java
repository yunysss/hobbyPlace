...
/**
 * Servlet implementation class TutorQnaDetailView1Controller
 */
@WebServlet("/ttQna1.ad")
public class TutorQnaDetailView1Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TutorQnaDetailView1Controller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin/tutorQnaDetailView1.jsp").forward(request, response);
	}

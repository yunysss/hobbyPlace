...
/**
 * Servlet implementation class DeleteTrollReviewController
 */
@WebServlet("/deleteRe.ad")
public class DeleteTrollReviewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteTrollReviewController() {
        super();

...
/**
 * Servlet implementation class AdminNoticeListTutorController
 */
@WebServlet("/tutorNotice.ad")
public class AdminNoticeListTutorController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminNoticeListTutorController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin/adminNoticeTutorList.jsp").forward(request, response);
	}

...
/**
 * Servlet implementation class tutorFaqListController
 */
@WebServlet("/faqlist.tor")
public class tutorFaqListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public tutorFaqListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/customerService/tutorFaqList.jsp").forward(request, response);}

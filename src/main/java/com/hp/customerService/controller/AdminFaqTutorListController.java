...
/**
 * Servlet implementation class AdminFaqTutorListController
 */
@WebServlet("/faqListTutor.ad")
public class AdminFaqTutorListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFaqTutorListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new NoticeService().selectTutorFaqListCount();
		...
		ArrayList<Faq> list = new NoticeService().selectTutorFaqList(pi);
		
		request.setAttribute("pi", pi);
		request.setAttribute("list", list);
		
		request.getRequestDispatcher("views/customerService/adminfaqListTutor.jsp").forward(request, response);
	}

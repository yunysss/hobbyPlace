...
/**
 * Servlet implementation class AdminFaqTuteeListController
 */
@WebServlet("/faqListTutee.ad")
public class AdminFaqTuteeListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFaqTuteeListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/customerService/adminFaqListTutee.jsp").forward(request, response);
	}

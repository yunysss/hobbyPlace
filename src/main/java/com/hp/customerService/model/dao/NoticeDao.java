...
public class NoticeDao {
		...
		public ArrayList<Faq> keywordFaqTutee(Connection conn, String keyword){
			ArrayList<Faq> list= new ArrayList<>();
			PreparedStatement pstmt = null;
			ResultSet rset = null;
			String sql = prop.getProperty("keywordFaqTutee");
		...
		public ArrayList<Notice> keywordNoticeTutee(Connection conn, String keyword){
			ArrayList<Notice> list= new ArrayList<>();
			PreparedStatement pstmt = null;
			ResultSet rset = null;
			String sql = prop.getProperty("keywordNoticeTutee");
		...
		public ArrayList<Notice> keywordNoticeTutor(Connection conn, String keyword){
			ArrayList<Notice> list= new ArrayList<>();
			PreparedStatement pstmt = null;
			ResultSet rset = null;
			String sql = prop.getProperty("keywordNoticeTutor");

...
/**
 * Servlet implementation class AjaxEmailCheckForPwdController
 */
@WebServlet("/mailForPwd.me")
public class AjaxEmailCheckForPwdController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxEmailCheckForPwdController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Member m = new MemberService().emailCheckForPwd(memId, email);
		...
		if(m==null || !m.getEmail().equals(email)) {//일치하는 회원번호 찾기 실패
            ...
            try {
                ...
                //메일 내용
                msg.setText(m.getMemName() + "님이 요청한 인증 번호 : " + temp);

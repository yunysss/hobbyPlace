...
/**
 * Servlet implementation class AjaxPhoneCheckForPwdController
 */
@WebServlet("/pwdByPhone.me")
public class AjaxPhoneCheckForPwdController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxPhoneCheckForPwdController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Member m = new MemberService().phoneCheckForPwd(memId, phone);
		
		if(m==null || !m.getPhone().equals(phone)) {//일치하는 회원번호 찾기 실패
